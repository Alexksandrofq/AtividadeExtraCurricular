...
public class NavegadorDeRegistro extends TelaDePesquisa {
    ...
    }// Aqui fecha o método pesquisar

    public static void historicoArmazenado() {
        try {
            Connection conexao = MySQLConnector.conectar();
            String strSqlHistorico = "insert into `db_senac`.`tbl_historico` where (`termo_pesquisado`) values (?);";
            PreparedStatement stmSqlHistorico = conexao.prepareStatement(strSqlHistorico);
            stmSqlHistorico.executeUpdate();
            stmSqlHistorico.close();
            conexao.close();
        } catch (Exception e) {
            System.err.println("Erro: " + e);
        }
    ...
    }// Aquifecha o método  primeiroRegistro
    ...
    }// Aqui fecha o método registroAnterior
    ...
    }// Aqui feche o método proximoRegistro
    ...
    }// Aqui fecha o mpetodo ultimoRegistro
