...
public class TelaDePesquisa extends JFrame
{
    ...
    public TelaDePesquisa()
    {
        ...
        btnHistorico = new JButton ("H");
        btnHistorico.setEnabled(false);
        linha_inputPesquisa.add(btnHistorico);
            ...
            new ActionListener() {
                ...
                public void actionPerformed(ActionEvent event) {
                    if (txtPesquisa.getText().trim().length() <= 0) {
                        ...
                        NavegadorDeRegistro.historicoArmazenado();
                    }
        ...
        btnHistorico.addActionListener(
            new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent event) {
                    TelaDeHistorico telaDeHistorico = new TelaDeHistorico();// Aqui cria um novo objeto, telaDeHistorico estede JFrame
                    telaDeHistorico.setVisible(true);// Aqui torna a tela visivel 
                }
            }
        );
